...
def get_meaning(word):
    try:
        ...
        pass
    return "Sign recognized (Definition unavailable)"
...
async def websocket_endpoint(websocket: WebSocket):
    ...
    try:
        while True:
            ...
            resp = {"text": f"{sentence} {current_word}".strip(), "current_letter": "-", "confidence": 0}
            ...
            if landmarks:
                ...
                base = landmarks[0]
                for lm in landmarks:
                    input_data.extend([lm[0]-base[0], lm[1]-base[1], lm[2]])
                ...
                if no_hand_count >= 15 and current_word:
                    ...
                    resp["completed_word"] = word_to_speak
                    resp["meaning"] = get_meaning(word_to_speak)
                    resp["speak"] = word_to_speak
                    sentence += current_word + " "
                    current_word = ""
                    no_hand_count = 0
